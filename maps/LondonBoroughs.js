window.JSMaps.maps.LondonBoroughs = {
	"config": {
		...
		"defaultText": "<h1>London Boroughs</h1><br /><p>The 32 London boroughs are the local authority districts of the Greater London administrative area (the 33rd is the City of London). Each area is is a local government district governed by a London borough council. The London boroughs were all created on 1 April 1965 by the London Government Act 1963.</p>"
	},
	"paths": [
		{
			"enable": true,
			...
			"url": "http://jsmaps.io/",
			"text": "<h1>City</h1><br /><p>The Square Mile was once the old city contained within the medieval walls.It is now the nation's financial centre and embodies the capital's mix of tradition and change. This tiny area, only twenty minutes walk from one side to the other, generates 3% of the UK's income.</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Barking and Dagenham</h1><br /><p>Barking and Dagenham lies to the east of central London. Areas of interest within the borough include the ruined Anglo-Saxon Barking Abbey, built in 666AD.Barking and Dagenham was one of six London boroughs to host the 2012 Summer Olympics. </p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Bexley</h1><br /><p>Although only 12 miles south east of central London (30 minutes by train), Bexley boasts over 1500 acres of open space and green parkland. Danson Park, believed to have been landscaped by the famous 'Capability Brown', is the setting for many of Bexley's annual summer events.</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Brent</h1><br /><p>Brent's most famous feature is the legendary Wembley Stadium, the home of English football. Wembley Arena also attracts huge crowds and is one the capital's largest music venues. Brent is a multi-cultural heartland and offers fascinating glimpses into London's many faiths. </p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Greenwich</h1><br /><p>The London Borough of Greenwich lies on the south bank of the Thames. Rich in maritime history, Greenwich also has an outstanding architectural heritage. Many of its buildings are designed by well known English architects, including the Royal Naval College, the National Maritime Museum and the Royal Observatory built by Sir Christopher Wren for King Charles II. At the Royal Observatory visitors can stand astride Longitude Zero with one foot in the eastern and the other in the western hemisphere. </p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Hounslow</h1><br /><p>Hounslow boasts a wealth of heritage attractions, beautiful parks, open country areas and riverside walks.The Borough is home to the London Museum of Water & Steam and the attractions of Osterley Park, Gunnersbury Park, Syon House, and Chiswick House. </p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Merton</h1><br /><p>Merton is home to the legendary Wimbledon Lawn Tennis Championships, held every year for two weeks during June/July. The Wimbledon Lawn Tennis Museum, open throughout the year, provides visitors with views over the Centre Court and films of matches. </p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Waltham Forest</h1><br /><p>The Borough of Waltham Forest lies to the east of central London, with its centre, Walthamstow, located 30 minutes from the city. For shoppers, Walthamstow is home to Britain's longest street market, providing nearly one mile of stalls selling everything from hardware to food and clothes. Famous people connected with the borough include Benjamin Disraeli who was educated locally and William Morris, the 19th-century artist, poet and craftsman. The Morris family home, dating back to the mid 18th century, is now the William Morris Gallery located in Lloyd Park.</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Wandsworth</h1><br /><p>Wandsworth is a picturesque borough set in the heart of south London on the banks of the Thames. Battersea Power Station's towering chimneys dominate the skyline. Battersea Park is the borough's major area of green space. Putney, in the west of the borough, is the starting point for the world famous Oxford and Cambridge Boat Race. Explore the river in both directions from Putney Pier and take a boat trips up river to Kew Gardens or down river to Westminster</p>",
		...
		},
		{
			...
			"selectedColor": "#feb41c",
			"url": "http://jsmaps.io/",
			"text": "<h1>Haringey</h1><br /><p> <blockquote>Haringey is famous for its literary connections such as Sir John Betjeman and also Karl Marx who is buried in nearby Highgate Cemetery.In the Western half of the borough stands Alexandra Palace, the last great Victorian exhibition space in Europe and the birth place of television. The Parkland Walk links Alexandra Palace to Finsbury Park.</blockquote></p>",
